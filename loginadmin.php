...
if(!empty($_POST['email']) && !empty($_POST['password'])){
    $cons = $connection->prepare('SELECT username,email,password FROM users_admin WHERE email=:email');
    ...
    header("Location: http://localhost/blog/asignaturas.php");
    die();
    ...
    <div id="wrapper">
        <div id="contenedor">
            <div id="contenido">
                ...
                <div class="" id="">
                    <div class="titulo">
                        <a href="login.php" ><button class="subbutton">Login Alumnos</button></a>
                        <a href="loginadmin.php" ><button id="subactive" class="subbutton">Login Admin</button></a>
                    </div>
                </div>
