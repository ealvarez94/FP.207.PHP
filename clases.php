        ...
        <div id="contenido">
            <div id="">
                <div class="menu">
                    ...
                    <a href="clases.php" ><button id="active" class="button">Clases</button></a>
            ...
            <div class="" id="">
                <div class="titulo">
                    <a href="asignaturas.php" ><button id="subactive" class="subbutton">Crear Clase</button></a>
                    <a href="" ><button class="subbutton">Administrar Clases</button></a>
                </div>
            </div>
            ...
            <div class="contenido2" id="seccion2">
                ...
                <form action="asignaturas.php" method="post">
                    ...
                    <select style="width: 250px;
                            ...
                            background-color: #e5e5e5;
                            border-radius: 2px;
                            border: 0px;"><option value="0">Elige un Horario</option>
                    </select>
                    </br> <label>Nombre:</label>
                    <input type="text" name="date_start" placeholder="Introduce la fecha de inicio">
                    <label>Color:</label>
                    <input type="text" name="date_end" placeholder="Introduce la fecha de fin">
                    <div class="enviar">
